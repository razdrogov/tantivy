...
pub struct CompositeFile {
    data: FileSlice,
    offsets_index: HashMap<FileAddr, Range<u64>>,
}
...
impl CompositeFile {
    ...
    pub fn open(data: &FileSlice) -> io::Result<CompositeFile> {
        ...
        let footer_len = u32::deserialize(&mut footer_len_data.as_slice())? as u64;
        ...
        for _ in 0..num_fields {
            offset += VInt::deserialize(&mut footer_buffer)?.0 as u64;
    ...
    pub fn space_usage(&self) -> PerFieldSpaceUsage {
        ...
        for (&field_addr, byte_range) in &self.offsets_index {
            ...
            field_usage.add_field_idx(field_addr.idx, (byte_range.end - byte_range.start).into());
...
impl CompositeFile {
    pub async fn open_async(data: &FileSlice) -> io::Result<CompositeFile> {
        ...
        let footer_len = u32::deserialize(&mut footer_len_data.as_slice())? as u64;
        let footer_start = end - 4 - footer_len as u64;
        let footer_data = data
            .slice(footer_start..footer_start + footer_len)
            .read_bytes_async()
            .await?;
